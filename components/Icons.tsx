...
export const SatelliteIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M13 7 9 3 5 7"/><path d="M12.8 12.8 9 9"/><path d="m21 3-5 5"/><path d="m3 21 5-5"/><path d="m19 13-2 2"/><path d="m11 15-2 2"/><path d="m8.5 2.5 3 3 3-3a1 1 0 0 0-2-1.7l-1 1.7-1-1.7a1 1 0 0 0-2 1.7Z"/>
  </svg>
);
